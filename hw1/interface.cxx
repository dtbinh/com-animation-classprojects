...
Fl_Button *loadCloth_button=(Fl_Button *)0;
...
Fl_Button *quickStart_button=(Fl_Button *)0;
...
Fl_Light_Button *simulate_button=(Fl_Light_Button *)0;
...
Fl_Value_Input *IntegrateType=(Fl_Value_Input *)0;

Fl_Window* make_window() {
  Fl_Window* w;
  { Fl_Window* o = main_window = new Fl_Window(651, 622, "Cloth Simulation");
    w = o;
    { Fl_Group* o = new Fl_Group(10, 485, 615, 140);
	  ...
	  { Fl_Button* o = loadCloth_button = new Fl_Button(425, 495, 90, 40, "Load Cloth");
        o->callback((Fl_Callback*)load_callback);
      }
	  ...
	  { Fl_Light_Button* o = simulate_button = new Fl_Light_Button(225, 495, 75, 25, "Simulate");
        o->callback((Fl_Callback*)redisplay_proc, (void*)(0));
      }
      { Fl_Button* o = quickStart_button = new Fl_Button(550, 593, 30, 20, "Quick Start");
        o->callback((Fl_Callback*)load_callback);
      }
	  o->end();
    }
    ...
    { Fl_Value_Input* o = joint_idx = new Fl_Value_Input(65, 595, 30, 20, "Joint");
	 ...
	 { Fl_Value_Input* o = IntegrateType = new Fl_Value_Input(500, 595, 30, 20, "Integration");
      o->minimum(1);
      o->maximum(5);
      o->step(1);
      o->value(1);
